      ...
      <div className="profile-left">
        ...
        <div className="profile-text-left">
          ...
          <p>
            ...
            Jujutsu Kaisen. Conocido con el apodo de El Chamán Más Fuerte, es
            uno de los cuatro chamanes de Clase Especial, antiguo compañero de
            Suguru Geto y Shoko Ieiri, y actual profesor del Colegio Técnico de
            Magia Metropolitana de Tokio, encargado de los alumnos de primer
            año.
          </p>
        </div>
      </div>
      <div className="profile-right">
        <div className="profile-text-right">
          ...
          <p>
            ...
            de Tokio y recipiente del Rey de las Maldiciones, Sukuna.
          </p>
        </div>
      ...
      <div className="profile-left">
        ...
        <div className="profile-text-left">
          ...
          <p>
            ...
            estudiante de primer año del Colegio Técnico de Magia Metropolitana
            de Tokio, y compañero de Yuji Itadori y Nobara Kugisaki.
          </p>
        </div>
      </div>
      <div className="profile-right">
        <div className="profile-text-right">
          ...
          <p>
            ...
            estudiante de primer año del Colegio Técnico de Magia Metropolitana
            de Tokio, y compañera de Yuji Itadori y Megumi Fushiguro.
          </p>
        </div>
        <div className="profile-img-right">
          <img
